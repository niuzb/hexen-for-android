...
default_t defaults[] =
{
	...
	{ "key_strafeleft", &key_strafeleft, KEY_HOME },
	{ "key_straferight", &key_straferight, KEY_PGUP },
	{ "key_jump", &key_jump, 'x'},
	{ "key_flyup", &key_flyup, 'w' },
	{ "key_flydown", &key_flydown, 's' },
	{ "key_flycenter", &key_flycenter, 'c' },
	{ "key_lookup", &key_lookup, 'q' },
	{ "key_lookdown", &key_lookdown, 'z' },
	{ "key_lookcenter", &key_lookcenter, 'a' },
	{ "key_invleft", &key_invleft, '[' },
	{ "key_invright", &key_invright, ']' },
	{ "key_useartifact", &key_useartifact, 13 },

	{ "key_fire", &key_fire, ' ', 1 },
	{ "key_use", &key_use, KEY_RCTRL, 1 },
	...
	{ "mouse_scale_factor", &mouse_scale_factor, 10 },
...
void M_LoadDefaults(char *fileName)
{
	...
	{
		sprintf(defaultfile, "/cdrom/hexndata/%s", fileName);
	}
	else
	{
	 ...
	 char *home;
	 home=getenv("HOME");
	 if (!home) I_Error("M_LoadDefaults: cannot localte home dir!");
	 strcpy(defaultfile,home);
	 strcat(defaultfile,"/.hexenrc");
#else
	 strcpy(defaultfile,"HEXEN.RC");
#endif
	}
