...
void *Z_Malloc (int size, int tag, void *user)
{
	...
	//LOGI("Z_Malloc size:%d, tag:%d", size, tag);
//
...
//
	...
	//while (i < size)
		//i <<= 1;
//	LOGI(" i %d, size %d", i, size);
	//size = i;
	
	//LOGI("sizeof(memblock_t):%x", sizeof(memblock_t));
...
//
	...
	if (user)
	{
		...
		//LOGI("Z_Malloc user:%p", ((byte *)base + sizeof(memblock_t)));
	...
	//LOGI("Z_Malloc return:%p", ((byte *)base + sizeof(memblock_t)));
